...
export type GroupsArrayBase = Array<string|undefined>;
export type NamedGroupsBase = {[k:string]:string|undefined};

/** normal parsing */
export type ParseRegExp<R extends string> =
    R extends "" ? { g: [], ng: {} } :
    ParsePart<R> extends { g: infer G extends GroupsArrayBase, ng: infer NG extends NamedGroupsBase, r: infer R extends string } ?
        ParseRegExp<R> extends { g: infer G2 extends GroupsArrayBase, ng: infer NG2 extends NamedGroupsBase } ? { g: [...G,...G2], ng: NG & NG2 } :
        undefined :
    undefined;

type ParseAlternative<R extends string> =
...
type ParseGroup<R extends string> =
    R extends `?${infer R extends string}` ?
        ...
        R extends `<${infer R extends string}` ?
            R extends `=${infer R extends string}` ? ParseGroup_<R> :
            R extends `!${infer R extends string}` ? ParseGroup_<R> :
            ParseGroupName<R> extends { ng: infer NG extends NamedGroupsBase, r: infer R extends string } ?
                ParseGroup_<R> extends { g: infer G2 extends GroupsArrayBase, ng: infer NG2 extends NamedGroupsBase, r: infer R extends string } ? { g: G2, ng: NG & NG2, r: R } : undefined :
            undefined :
        undefined :
    ParseGroup_<R> extends { g: infer G extends GroupsArrayBase, ng: infer NG extends NamedGroupsBase, r: infer R extends string } ? { g: [string,...G], ng: NG, r: R } :
    R extends `${infer C extends string}${infer R extends string}` ? string extends C ? { g: GroupsArrayBase, ng: NamedGroupsBase, r: R } : undefined : undefined;
...
type ParseGroup_<R extends string> =
    ...
    ParsePart<R> extends { g: infer G extends GroupsArrayBase, ng: infer NG extends NamedGroupsBase, r: infer R extends string } ? ParseGroup_<R> extends { g: infer G2 extends GroupsArrayBase, ng: infer NG2 extends NamedGroupsBase, r: infer R extends string } ? { g: [...G,...G2], ng: NG & NG2, r: R } : undefined :
    undefined;

/** parse parts with modifiers ? * + and there non-greedy versions */
type ParsePart<R extends string> =
    ParsePart_<R> extends { g: infer G extends GroupsArrayBase, ng: infer NG extends NamedGroupsBase, r: infer R extends string } ?
        R extends `?${infer R extends string}` ?
...
type ParsePart_<R extends string> =
    ...
    R extends `\\${infer R extends string}` ?
        ...
        R extends `k<${infer R extends string}` ?
            ParseGroupName<R> extends { ng: infer _NG extends NamedGroupsBase, r: infer R extends string } ? { g: [], ng: {}, r: R } :
            undefined :
        undefined :
    undefined;
